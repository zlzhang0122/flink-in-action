...
public class HbaseClient {
    ...
    static {
        ...
        conf.set("hbase.rootdir", PropertiesUtil.getStrValue("hbase.rootdir"));
        conf.set("hbase.zookeeper.quorum", PropertiesUtil.getStrValue("hbase.zookeeper.quorum"));
        conf.set("hbase.client.scanner.timeout.period", PropertiesUtil.getStrValue("hbase.client.scanner.timeout.period"));
        conf.set("hbase.rpc.timeout", PropertiesUtil.getStrValue("hbase.rpc.timeout"));
